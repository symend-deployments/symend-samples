...
```
nuget pack -Build -OutputDirectory out Symend.Client.Customer.csproj
```
...
## Documentation for Models
 ...
 - [Model.AccountSummarySearchCriteria](docs/AccountSummarySearchCriteria.md)
 ...
 - [Model.CursorPagingCriteria](docs/CursorPagingCriteria.md)
 ...
 - [Model.PagedMetadata](docs/PagedMetadata.md)
