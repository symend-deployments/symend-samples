...
namespace Symend.Client.Customer.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DataTargetDefinitionModel")]
    public partial class DataTargetDefinitionModel : IEquatable<DataTargetDefinitionModel>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataTargetDefinitionModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataTargetDefinitionModel {\n");
        ...
        {
            return this.Equals(input as DataTargetDefinitionModel);
        }

        /// <summary>
        /// Returns true if DataTargetDefinitionModel instances are equal
        /// </summary>
        /// <param name="input">Instance of DataTargetDefinitionModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataTargetDefinitionModel input)
        {
            if (input == null)
            {
                return false;
