...
namespace Symend.Client.Customer.Api
{
    ...
    /// </summary>
    public interface ISymPermUpdateAccountApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISymPermUpdateAccountApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISymPermUpdateAccountApi : ISymPermUpdateAccountApiSync, ISymPermUpdateAccountApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SymPermUpdateAccountApi : ISymPermUpdateAccountApi
    {
        private Symend.Client.Customer.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SymPermUpdateAccountApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SymPermUpdateAccountApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public SymPermUpdateAccountApi(string basePath)
        {
        ...
        /// <returns></returns>
        public SymPermUpdateAccountApi(Symend.Client.Customer.Client.Configuration configuration)
        {
        ...
        public SymPermUpdateAccountApi(Symend.Client.Customer.Client.ISynchronousClient client, Symend.Client.Customer.Client.IAsynchronousClient asyncClient, Symend.Client.Customer.Client.IReadableConfiguration configuration)
        {
        ...
        public Symend.Client.Customer.Client.ApiResponse<AccountResponseResultModel> UpdateAccountWithHttpInfo(Guid id, Guid xSymOrganizationId, AccountForm accountForm = default(AccountForm), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SymPermUpdateAccountApi.UpdateAccount";
