...
namespace Symend.Client.Customer.Api
{
    ...
    /// </summary>
    public interface IListEventTypesApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IListEventTypesApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IListEventTypesApi : IListEventTypesApiSync, IListEventTypesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ListEventTypesApi : IListEventTypesApi
    {
        private Symend.Client.Customer.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ListEventTypesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ListEventTypesApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ListEventTypesApi(string basePath)
        {
        ...
        /// <returns></returns>
        public ListEventTypesApi(Symend.Client.Customer.Client.Configuration configuration)
        {
        ...
        public ListEventTypesApi(Symend.Client.Customer.Client.ISynchronousClient client, Symend.Client.Customer.Client.IAsynchronousClient asyncClient, Symend.Client.Customer.Client.IReadableConfiguration configuration)
        {
        ...
        public Symend.Client.Customer.Client.ApiResponse<CustomerTrailEventTypeCollectionModel> ListCustomerTrailEventTypesWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ListEventTypesApi.ListCustomerTrailEventTypes";
