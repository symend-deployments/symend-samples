...
namespace Symend.Client.Customer.Api
{
    ...
    /// </summary>
    public interface ISymPermCreateAccountApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISymPermCreateAccountApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISymPermCreateAccountApi : ISymPermCreateAccountApiSync, ISymPermCreateAccountApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SymPermCreateAccountApi : ISymPermCreateAccountApi
    {
        private Symend.Client.Customer.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SymPermCreateAccountApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SymPermCreateAccountApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public SymPermCreateAccountApi(string basePath)
        {
        ...
        /// <returns></returns>
        public SymPermCreateAccountApi(Symend.Client.Customer.Client.Configuration configuration)
        {
        ...
        public SymPermCreateAccountApi(Symend.Client.Customer.Client.ISynchronousClient client, Symend.Client.Customer.Client.IAsynchronousClient asyncClient, Symend.Client.Customer.Client.IReadableConfiguration configuration)
        {
        ...
        public Symend.Client.Customer.Client.ApiResponse<AccountResponseResultModel> CreateUpdateAccountWithHttpInfo(Guid xSymOrganizationId, AccountForm accountForm = default(AccountForm), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SymPermCreateAccountApi.CreateUpdateAccount";
