...
namespace Symend.Client.Customer.Api
{
    ...
    /// </summary>
    public interface ISymPermViewDataAttributesApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISymPermViewDataAttributesApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISymPermViewDataAttributesApi : ISymPermViewDataAttributesApiSync, ISymPermViewDataAttributesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SymPermViewDataAttributesApi : ISymPermViewDataAttributesApi
    {
        private Symend.Client.Customer.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SymPermViewDataAttributesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SymPermViewDataAttributesApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public SymPermViewDataAttributesApi(string basePath)
        {
        ...
        /// <returns></returns>
        public SymPermViewDataAttributesApi(Symend.Client.Customer.Client.Configuration configuration)
        {
        ...
        public SymPermViewDataAttributesApi(Symend.Client.Customer.Client.ISynchronousClient client, Symend.Client.Customer.Client.IAsynchronousClient asyncClient, Symend.Client.Customer.Client.IReadableConfiguration configuration)
        {
        ...
        public Symend.Client.Customer.Client.ApiResponse<StringIEnumerableResultModel> GetDataCategoriesWithHttpInfo(Guid xSymOrganizationId, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SymPermViewDataAttributesApi.GetDataCategories";
        ...
        public Symend.Client.Customer.Client.ApiResponse<DataTargetDefinitionModelResultModel> GetDataTargetDefinitionWithHttpInfo(Guid dataTargetDefinitionId, Guid xSymOrganizationId, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SymPermViewDataAttributesApi.GetDataTargetDefinition";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public Symend.Client.Customer.Client.ApiResponse<DataTargetDefinitionSearchResultGuidPagedModel> GetDataTargetDefinitionsWithHttpInfo(Guid xSymOrganizationId, GetDataTargetDefinitionsDataTargetDefinitionSearchCriteriaParameter dataTargetDefinitionSearchCriteria = default(GetDataTargetDefinitionsDataTargetDefinitionSearchCriteriaParameter), GuidPagedMetadata paging = default(GuidPagedMetadata), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SymPermViewDataAttributesApi.GetDataTargetDefinitions";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public Symend.Client.Customer.Client.ApiResponse<GuidDataTargetDefinitionDictionaryModelIDictionaryResultModel> GetDataTargetDefinitionsDictionaryWithHttpInfo(Guid xSymOrganizationId, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SymPermViewDataAttributesApi.GetDataTargetDefinitionsDictionary";
            localVarRequestOptions.OperationIndex = operationIndex;
