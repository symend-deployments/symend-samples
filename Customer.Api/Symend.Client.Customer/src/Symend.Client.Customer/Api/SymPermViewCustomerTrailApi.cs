...
namespace Symend.Client.Customer.Api
{
    ...
    public partial class SymPermViewCustomerTrailApi : ISymPermViewCustomerTrailApi
    {
        ...
        public Symend.Client.Customer.Client.ApiResponse<CustomerTrailEventAttributeValueResultModel> GetAttributeValuesByEventIdWithHttpInfo(string eventId, int operationIndex = 0)
        {
            ...
            if (eventId == null)
            {
                throw new Symend.Client.Customer.Client.ApiException(400, "Missing required parameter 'eventId' when calling SymPermViewCustomerTrailApi->GetAttributeValuesByEventId");
            }
            ...
            localVarRequestOptions.Operation = "SymPermViewCustomerTrailApi.GetAttributeValuesByEventId";
        ...
        public Symend.Client.Customer.Client.ApiResponse<CustomerTrailEventPagedModelV2> GetCustomerEventsByAccountKeyOrderByDateTimeWithHttpInfo(Guid xSymOrganizationId, string accountKey, string interval, GuidPagedMetadata paging = default(GuidPagedMetadata), GetCustomerEventsByAccountKeyOrderByDateTimeSearchParameterParameter searchParameter = default(GetCustomerEventsByAccountKeyOrderByDateTimeSearchParameterParameter), int operationIndex = 0)
        {
            ...
            if (accountKey == null)
            {
                throw new Symend.Client.Customer.Client.ApiException(400, "Missing required parameter 'accountKey' when calling SymPermViewCustomerTrailApi->GetCustomerEventsByAccountKeyOrderByDateTime");
            }

            // verify the required parameter 'interval' is set
            if (interval == null)
            {
                throw new Symend.Client.Customer.Client.ApiException(400, "Missing required parameter 'interval' when calling SymPermViewCustomerTrailApi->GetCustomerEventsByAccountKeyOrderByDateTime");
            }
            ...
            localVarRequestOptions.Operation = "SymPermViewCustomerTrailApi.GetCustomerEventsByAccountKeyOrderByDateTime";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public Symend.Client.Customer.Client.ApiResponse<CustomerTrailEventPagedModel> GetCustomerTrailEventsForAccountWithHttpInfo(string id, Guid xSymOrganizationId, GetCustomerTrailEventsForAccountSearchParameterParameter searchParameter = default(GetCustomerTrailEventsForAccountSearchParameterParameter), GuidPagedMetadata paging = default(GuidPagedMetadata), int operationIndex = 0)
        {
            ...
            if (id == null)
            {
                throw new Symend.Client.Customer.Client.ApiException(400, "Missing required parameter 'id' when calling SymPermViewCustomerTrailApi->GetCustomerTrailEventsForAccount");
            }
            ...
            localVarRequestOptions.Operation = "SymPermViewCustomerTrailApi.GetCustomerTrailEventsForAccount";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public Symend.Client.Customer.Client.ApiResponse<CustomerTrailEventPagedModelV2> GetCustomerTrailEventsForAccountPagedDateTimeWithHttpInfo(string id, Guid xSymOrganizationId, string interval, GetCustomerEventsByAccountKeyOrderByDateTimeSearchParameterParameter searchParameter = default(GetCustomerEventsByAccountKeyOrderByDateTimeSearchParameterParameter), int operationIndex = 0)
        {
            ...
            if (id == null)
            {
                throw new Symend.Client.Customer.Client.ApiException(400, "Missing required parameter 'id' when calling SymPermViewCustomerTrailApi->GetCustomerTrailEventsForAccountPagedDateTime");
            }

            // verify the required parameter 'interval' is set
            if (interval == null)
            {
                throw new Symend.Client.Customer.Client.ApiException(400, "Missing required parameter 'interval' when calling SymPermViewCustomerTrailApi->GetCustomerTrailEventsForAccountPagedDateTime");
            }
            ...
            localVarRequestOptions.Operation = "SymPermViewCustomerTrailApi.GetCustomerTrailEventsForAccountPagedDateTime";
            localVarRequestOptions.OperationIndex = operationIndex;
