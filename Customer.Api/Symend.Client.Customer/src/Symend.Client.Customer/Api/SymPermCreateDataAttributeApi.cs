...
namespace Symend.Client.Customer.Api
{
    ...
    /// </summary>
    public interface ISymPermCreateDataAttributeApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISymPermCreateDataAttributeApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISymPermCreateDataAttributeApi : ISymPermCreateDataAttributeApiSync, ISymPermCreateDataAttributeApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SymPermCreateDataAttributeApi : ISymPermCreateDataAttributeApi
    {
        private Symend.Client.Customer.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SymPermCreateDataAttributeApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SymPermCreateDataAttributeApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public SymPermCreateDataAttributeApi(string basePath)
        {
        ...
        /// <returns></returns>
        public SymPermCreateDataAttributeApi(Symend.Client.Customer.Client.Configuration configuration)
        {
        ...
        public SymPermCreateDataAttributeApi(Symend.Client.Customer.Client.ISynchronousClient client, Symend.Client.Customer.Client.IAsynchronousClient asyncClient, Symend.Client.Customer.Client.IReadableConfiguration configuration)
        {
        ...
        public Symend.Client.Customer.Client.ApiResponse<DataTargetDefinitionModelResultModel> CreateDataTargetDefinitionWithHttpInfo(Guid xSymOrganizationId, DataTargetDefinitionForm dataTargetDefinitionForm = default(DataTargetDefinitionForm), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SymPermCreateDataAttributeApi.CreateDataTargetDefinition";
