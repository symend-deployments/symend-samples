...
namespace Symend.Client.Customer.Api
{
    ...
    /// </summary>
    public interface ISymPermViewAccountsApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISymPermViewAccountsApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISymPermViewAccountsApi : ISymPermViewAccountsApiSync, ISymPermViewAccountsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SymPermViewAccountsApi : ISymPermViewAccountsApi
    {
        private Symend.Client.Customer.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SymPermViewAccountsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SymPermViewAccountsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public SymPermViewAccountsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public SymPermViewAccountsApi(Symend.Client.Customer.Client.Configuration configuration)
        {
        ...
        public SymPermViewAccountsApi(Symend.Client.Customer.Client.ISynchronousClient client, Symend.Client.Customer.Client.IAsynchronousClient asyncClient, Symend.Client.Customer.Client.IReadableConfiguration configuration)
        {
        ...
        public Symend.Client.Customer.Client.ApiResponse<AccountExtendedModelResultModel> GetAccountWithHttpInfo(Guid id, Guid xSymOrganizationId, int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SymPermViewAccountsApi.GetAccount";
        ...
        public Symend.Client.Customer.Client.ApiResponse<AccountSummarySearchResultGuidPagedModel> ListAccountSummaryWithHttpInfo(Guid xSymOrganizationId, string accountKey = default(string), string email = default(string), string phone = default(string), int? limit = default(int?), string direction = default(string), string orderByAttribute = default(string), string orderByLastValue = default(string), Guid? cursor = default(Guid?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SymPermViewAccountsApi.ListAccountSummary";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        public Symend.Client.Customer.Client.ApiResponse<AccountSearchResultGuidPagedModel> ListAccountsWithHttpInfo(Guid xSymOrganizationId, string accountKey = default(string), string email = default(string), string phone = default(string), int? limit = default(int?), string direction = default(string), string orderByAttribute = default(string), string orderByLastValue = default(string), Guid? cursor = default(Guid?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SymPermViewAccountsApi.ListAccounts";
            localVarRequestOptions.OperationIndex = operationIndex;
